       ...
       Text(
        ...
        Row(
            ...
            Button(
                ...
                Text(text = "Save", color = androidx.compose.ui.graphics.Color.White, fontSize = 18.sp)
            }
            ...
            Button(
                ...
                Text(text = "Load", color = androidx.compose.ui.graphics.Color.White, fontSize = 18.sp)
            }
            ...
            Button(
                ...
                Text(text = "Clear", color = androidx.compose.ui.graphics.Color.White, fontSize = 18.sp)
            }
        }
